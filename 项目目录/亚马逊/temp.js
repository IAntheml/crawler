...
if (window.ue_ihb === 1) {
    ...
    var ue_id = '9DV45SSQANSCSDW8QXZ8'
      , ue_url = '/rd/uedata'
      , ue_navtiming = 1
      , ue_mid = 'ATVPDKIKX0DER'
      , ue_sid = '142-2083267-8932510'
      ...
      , ue_rpl_ns = 'cel-rpl'
      , ue_ddq = 1
      , ue_fpf = '//fls-na.amazon.com/1/batch/1/OP/ATVPDKIKX0DER:142-2083267-8932510:9DV45SSQANSCSDW8QXZ8$uedata=s:'
      , ue_sbuimp = 1
      , ue_ibft = 0
      , ue_sswmts = 0
      , ue_jsmtf = 0
    ...
    (function(d, h, N) {
        ...
        function S(k, b, c, q) {
            ...
            if (!a.paused && (b || u(c))) {
                ...
                var s = e("id", b) || a.id, t = e("id2", b), g = a.url + "?" + k + "&v=" + a.v + "&id=" + s, J = e("ctb", b) || e("wb", b), z;
                J && (g += "&ctb=" + J);
                t && (g += "&id2=" + t);
        ...
        a.v = "0.252301.0";
        a.paused = !1;
        var v = "hasOwnProperty", G = "beforeunload", K = "on" + G, V = "addEventListener", X = "removeEventListener", W = "attachEvent", Y = "detachEvent", da = {
            cf: "criticalFeature",
            af: "aboveTheFold",
            fn: "functional",
            fp: "firstPaint",
            ...
            be: "bodyEnd",
            ld: "loaded"
        }, E = h.Date, C = h.performance || h.webkitPerformance, f = (C || {}).timing, x = (C || {}).navigation, M = (f || {}).navigationStart, w = d.ue_fpf, Q = 0, U = 0, L = [], D = 0, F;
        a.oid = H(a.id);
        a.lid = H(a.id);
        a._t0 = a.t0;
        a.tag = P();
...
//第四步
window.ue && ue.count && ue.count('CSMLibrarySize', 9811)
...
window.ue_ihe = (window.ue_ihe || 0) + 1;
            if (window.ue_ihe === 1) {
                ...
                (function(l, e) {
                    ...
                    var n = "; expires=" + (new Date(+new Date + 6048E5)).toGMTString(), m = "tb", f, a = l.ue || {}, k = a.pageViz && a.pageViz.event && a.pageViz.propHid;
