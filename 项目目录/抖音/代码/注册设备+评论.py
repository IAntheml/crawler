...
def get_comment_list():
    ...
    device_id = "1324270467154856"  # "1891579430189188"  # 必须 且 不能修改
    # iid = device_dict['install_id_str']  # "1082357444254472"  # 必须 且 不能修改
    iid = "1025205580873422"  # "1082357444254472"  # 必须 且 不能修改
    ...
    x_ss_stud, gorgon, khronos = get_gorgon(script, param_string, None)
